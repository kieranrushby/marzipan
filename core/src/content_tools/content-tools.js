...
(function() {
  ...
  ContentEdit = {
    ...
    addCSSClass: function(domElement, className) {
      ...
      /*
        Update
        Need to split the className string by space
      ...
      */
      ...
      for(i=0;i<classNameSplit.length;i++){
        if (domElement.classList) {
          domElement.classList.add(classNameSplit[i]);
          return;
        }
      }
  ...
  ContentEdit.Element = (function(_super) {
    ...
    Element.prototype.hasCSSClass = function(className) {
      var c, classNames, styleClassNames;

      if (this.attr('class')) {

        classNames = this.attr('class').split(' ');
        styleClassNames = className.split(' ');
        ...
        */
        ...
        for(var _i = 0; _i < styleClassNames.length; _i++){
          if (classNames.indexOf(styleClassNames[_i]) == -1) {
            return false;
          }
        }
  ...
  ContentEdit.Image = (function(_super) {
    ...
    Image.prototype.html = function(indent) {
      ...
      console.log(this._attributesToString());
    ...
    Image.apply = function(element, selection, callback) {
      ...
      dialog.addEventListener('save', (function(_this) {
        return function(ev) {
          ...
          * to allow the CSS to control image scaling
          *
          */
